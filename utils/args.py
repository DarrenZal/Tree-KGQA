...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default="webqsp", choices=["webqsp","lcquad-2.0","lcquad-2.0-kbpearl","qald-7","webqsp-wd","refi"], help="Dataset name")
    ...
    parser.add_argument("--paraphrase_q", action="store_true", help="Use paraphrasing or not")
